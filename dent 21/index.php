    ...
    <div class="doctors__content-about__block">
      <article class="doctors__card chief__doctors">
        ...
        <h4 class="doctors__deserts">
         Кандидат медицинских наук, стоматолог-ортопед, стаж более 20 лет.
        </h4>
      ...
      <article class="doctors__card chief__doctors-two">
        ...
        <p class="doctors__quote">
          <span>
            Я стоматолог по призванию, при чём ЧТО мне нравится больше
            терапевтическая  стоматология или хирургическая стоматология  я
            ещё не решил.
          </span>
          <span> Хочу ДЕЛАТЬ ДОБРОЕ, КРАСИВОЕ И НУЖНОЕ! </span>
          <span>
      ...
      <article class="doctors__card chief__doctors-three">
        ...
        <p class="doctors__quote">
          Я - стоматолог-ортодонт в нескольких поколениях. Исправляю не
          только положение зубов, но и учитываю связь прикуса, осанки, ВНЧС
          , мышц лица и спины. Поэтому в моих руках не только красота лица,
      ...
      <article class="doctors__card chief__doctors-three">
        ...
        <p class="doctors__quote">
			Настолько щепетильна и любит свою работу, что приходит на свое рабочее место за 1,5 часа до начала! Любит людей, животных и очень позитивна.
